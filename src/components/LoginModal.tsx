    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-slate-800 rounded-2xl max-w-md w-full p-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 bg-white hover:bg-gray-100 text-gray-800 rounded-lg font-semibold flex items-center justify-center gap-2 mb-4 disabled:opacity-50"
        >
        ...
        <form onSubmit={handleEmailLogin}>
          ...
          <input
            ...
            placeholder="Senha"
            className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 mb-4"
          />
          <button
            type="submit"
            disabled={loading}
